...
void BBP::RegenerateInds() {
    ...
    for( size_t i = 0; i < _fg->nrVars(); i++ ) {
        ...
        daiforeach( const Neighbor &I, _fg->nbV(i) ) {
            _ind_t index;
...
void BBP::RegenerateT() {
    ...
    for( size_t i = 0; i < _fg->nrVars(); i++ ) {
        ...
        daiforeach( const Neighbor &I, _fg->nbV(i) ) {
            ...
            daiforeach( const Neighbor &J, _fg->nbV(i) )
                if( J.node != I.node )
...
void BBP::RegenerateU() {
    ...
    for( size_t I = 0; I < _fg->nrFactors(); I++ ) {
        ...
        daiforeach( const Neighbor &i, _fg->nbF(I) ) {
            Prob prod( _fg->factor(I).states(), 1.0 );
            daiforeach( const Neighbor &j, _fg->nbF(I) )
                if( i.node != j.node ) {
        ...
        daiforeach( const Neighbor &I, _fg->nbV(i) ) {
            ...
            daiforeach( const Neighbor &j, _fg->nbF(I) )
                if( i != j ) {
                    ...
                    daiforeach( const Neighbor &k, _fg->nbF(I) ) {
    ...
    for( size_t I = 0; I < _fg->nrFactors(); I++ ) {
        ...
        daiforeach( const Neighbor &i, _fg->nbF(I) ) {
            ...
            daiforeach( const Neighbor &J, _fg->nbV(i) ) {
                if( I != J ) {
                    Prob prod( _fg->var(i).states(), 1.0 );
                    daiforeach( const Neighbor &K, _fg->nbV(i) )
...
//                 psi_1_prb.normalize();
    ...
    /*    if(1) {
        ...
        for(size_t i=0; i<bp_dual.nrVars(); i++) {
            // for each factor I ~ i
            daiforeach(size_t I, bp_dual.nbV(i)) {
