...
VarSet FactorGraph::Delta( size_t i ) const {
    ...
    VarSet Del;
    daiforeach( const Neighbor &I, nbV(i) ) // for all neighboring factors I of i
        daiforeach( const Neighbor &j, nbF(I) ) // for all neighboring variables j of I
            Del |= var(j);
