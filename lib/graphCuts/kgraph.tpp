...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void Graph<captype, tcaptype, flowtype>::print_graph_size()
	{
          printf("sizeof(node)=%ld\n", sizeof(node));
          printf("sizeof(arc)=%ld\n", sizeof(arc));
	}

template <typename captype, typename tcaptype, typename flowtype> 
	inline Graph<captype, tcaptype, flowtype>::Graph(int node_num_max, int edge_num_max, void (*err_function)(char *))
	: node_num(0),
	  nodeptr_block(NULL),
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline Graph<captype,tcaptype,flowtype>::~Graph()
{
	if (nodeptr_block) 
	{ 
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void Graph<captype,tcaptype,flowtype>::reset()
{
	node_last = nodes;
	arc_last = arcs;
	node_num = 0;
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void Graph<captype,tcaptype,flowtype>::reallocate_nodes(int num)
{
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline void Graph<captype,tcaptype,flowtype>::reallocate_arcs()
{
